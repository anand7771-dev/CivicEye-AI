  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/3 w-64 h-64 rounded-full blur-3xl opacity-20"
      ...
      >
        ...
        <div className="glass-card p-8">
          ...
          <p className="text-civic-text-muted text-sm mb-6">Sign in to continue reporting civic issues</p>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-civic-text-dim">or sign in with email</span>
            <div className="flex-1 h-px bg-civic-border" />
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-civic-text-muted">
              Don't have an account?{' '}
              <Link to="/register" className="text-civic-blue-light hover:text-white font-medium transition-colors">
                Sign up free
              </Link>
            </p>
            <div className="flex justify-center gap-4 mt-3">
              <span className="inline-flex items-center gap-1 text-xs text-civic-text-dim px-2 py-1 rounded-lg bg-amber-900/20 border border-amber-500/20">
                🛡️ Admin Login
              </span>
              <span className="inline-flex items-center gap-1 text-xs text-civic-text-dim px-2 py-1 rounded-lg bg-blue-900/20 border border-blue-500/20">
                👤 Citizen Login
              </span>
            </div>
          </div>
        ...
        <p className="text-center text-xs text-civic-text-dim mt-4">
          Secured by Firebase Authentication · CivicEye AI
        </p>
      </motion.div>
    </div>
  );
